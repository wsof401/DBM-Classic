...
DBM_CORE_LOAD_MOD_TOC_MISMATCH		= "%s|1은;는; WoW 클래식 용으로 제작된 것이 아니라서 로딩할 수 없습니다. 최신 버전용 모듈을 설치한 것 같습니다. 해당 모듈은 삭제하시고 월드 오브 워크래프트 클래식 용으로 제작된 애드온만 사용하세요"
...
DBM_CORE_NOTEHEADER					= "%s에 대한 메모를 여기에 입력하세요. 캐릭터명을 >< 로 감싸면 직업 색상으로 표시됩니다. 여러번 경고가 필요한 경우 '/'로 메모를 구분해서 작성하세요."
...
DBM_CORE_OPTION_CATEGORY_ICONS			= "공격대 징표"
...
DBM_CORE_RANGECHECK_RHEADER			= "반전-탐지 거리 (%dm)"
DBM_CORE_RANGECHECK_RHEADERT		= "반전-탐지 거리 (%dm-%d명)"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.sooncount		= "곧 %s (%%s)"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.bait		= "곧 %s - 위치 유도"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.keepmove		= "%s - 계속 이동"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.stopmove		= "%s - 이동 금지"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.dodge		= "%s - 피하세요"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.dodgecount	= "%s (%%s) - 피하세요"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.dodgeloc		= "%s - %%s|1으로;로; 피하세요"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.moveaway		= "%s - 거리 이격"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.moveawaycount	= "%s (%%s) - 밖으로 나오세요"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.moveto		= "%s - >%%s<|1으로;로; 이동"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.soak		= "%s - 맞으세요"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.sooncount		= "$spell:%s 이전에 특수 경고 보기 (횟수 포함)"
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.bait			= "$spell:%s 이전에 특수 경고 보기 (위치 유도)"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.keepmove 		= "$spell:%s에 계속 이동 특수 경고 보기"
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.stopmove 		= "$spell:%s에 이동 금지 특수 경고 보기"
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.dodge			= "$spell:%s 피하기 특수 경고 보기"
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.dodgecount		= "$spell:%s 피하기 특수 경고 보기 (횟수 포함)"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.moveawaycount		= "$spell:%s에 밖으로 나오기 특수 경고 보기 (횟수 포함)"
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.moveto			= "$spell:%s에 특정인 또는 특정 위치로 이동 특수 경고 보기"
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.soak			= "$spell:%s 맞기 특수 경고 보기"
...
DBM_CORE_AUTO_YELL_OPTION_TEXT.fade		= "$spell:%s 지속시간이 끝나갈 때 말풍선으로 알리기 (주문 이름 및 초읽기 포함)"
DBM_CORE_AUTO_YELL_OPTION_TEXT.shortfade	= "$spell:%s 지속시간이 끝나갈 때 말풍선으로 알리기 (초읽기 포함)"
DBM_CORE_AUTO_YELL_OPTION_TEXT.iconfade		= "$spell:%s 지속시간이 끝나갈 때 말풍선으로 알리기 (초읽기 및 공격대 징표 포함)"
DBM_CORE_AUTO_YELL_OPTION_TEXT.position	= "$spell:%s 대상일 때 말풍선으로 알리기 (위치 포함)"
DBM_CORE_AUTO_YELL_OPTION_TEXT.combo		= "$spell:%s|1과;와; 다른 디버프가 같이 걸렸을 때 말풍선으로 알리기 (사용자 지정 문자 포함)"
